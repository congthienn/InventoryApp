...
{
    public partial class Create_Table_MaterialAttribute : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialAttribute", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialAttribute_CreatedByUserId",
                table: "MaterialAttribute",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialAttribute_UpdatedByUserId",
                table: "MaterialAttribute",
